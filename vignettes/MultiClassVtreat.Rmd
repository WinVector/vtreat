...
The two functions needed ([`mkCrossFrameMExperiment()`](https://winvector.github.io/vtreat/reference/mkCrossFrameMExperiment.html) and [`prepare()`](https://winvector.github.io/vtreat/reference/prepare.html)) are (as of version `1.2.4`) part of `vtreat`.
