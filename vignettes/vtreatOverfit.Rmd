...
First notice vtreat did thing there was any usable signal, and did not want us to use the variables (we got them by setting pruneSig=c()).  
...
So even better is to perform the 3-way data split, and set pruneSig to something reasonable.
