...
For categorical targets the possible variable types are as follows:
  ...
  * **cat\_D**: a "deviation fact" about a categorical level.  Tells us deviation of `y` conditioned by level for regression problems (this is inferable from **cat\_B** for classification tasks).
