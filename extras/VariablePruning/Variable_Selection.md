...
To work towards variable selection/pruning, let's work a specific Bayesian Regression example in [`R`](https://www.r-project.org). We are going to use the direct generative method described in the [long version of this article](https://github.com/WinVector/vtreat/blob/master/extras/VariablePruning/Variable_Selection_w_Appendices.pdf), instead of a package such as [`rstan`](https://CRAN.R-project.org/package=rstan) or [`lme4`](https://CRAN.R-project.org/package=lme4). This is because:
...
![](Variable_Selection_files/figure-markdown_github/unnamed-chunk-7-1.png)
...
![](Variable_Selection_files/figure-markdown_github/unnamed-chunk-8-1.png)
...
![](Variable_Selection_files/figure-markdown_github/unnamed-chunk-11-1.png)
...
![](Variable_Selection_files/figure-markdown_github/unnamed-chunk-12-1.png)
...
![](Variable_Selection_files/figure-markdown_github/unnamed-chunk-17-1.png)
...
![](Variable_Selection_files/figure-markdown_github/unnamed-chunk-18-1.png)

Keep in mind that `beta_1` isn't as interesting in this model formulation as `explanatory beta_1`, so the distribution of `beta_1` isn't as important as the distribution of `explanatory beta_1`.
...
![](Variable_Selection_files/figure-markdown_github/unnamed-chunk-19-1.png)
...
If a variable is in fact explanatory, then we want to see both `explanatory` move its distribution to `1` and for `explanatory * beta_1` to move to the right value.
...
![](Variable_Selection_files/figure-markdown_github/unnamed-chunk-22-1.png)
...
![](Variable_Selection_files/figure-markdown_github/unnamed-chunk-23-1.png)
