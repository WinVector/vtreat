...
Pipelines can be changed to functions (but note: they are a bit harder to combine after that as in the `wrapr`
dot pipe functions have a high combination precedence).
