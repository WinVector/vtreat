...
```
    ...
    ## [1] "vtreat 1.3.3 start initial treatment design Fri Nov 23 12:19:33 2018"
    ## [1] " start cross frame work Fri Nov 23 12:19:36 2018"
    ## [1] " vtreat::mkCrossFrameNExperiment done Fri Nov 23 12:19:41 2018"
...
We want a more explicit solution, that shows later code readers exactly what is going on (even if we have to be a bit more verbose). Such a solution is given by `wrapr`'s ["function object" abstraction](https://winvector.github.io/wrapr/articles/Function_Objects.html), which treats names of functions, plus arguments as an efficient notation for partial evaluation. We can use this system to encode our model prediction pipeline as follows.
...
![](ModelingPipelines_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
![](ModelingPipelines_files/figure-markdown_github/unnamed-chunk-6-2.png)
