...
[`vtreat`](https://github.com/WinVector/vtreat) transforms can be hosted
on [`rquery`](https://github.com/WinVector/rquery). This allows
transforms at scale.
...
```
    ...
    ## [1] "vtreat 1.2.1 inspecting inputs Thu Jun 28 07:33:26 2018"
    ## [1] "designing treatments Thu Jun 28 07:33:26 2018"
    ## [1] " have initial level statistics Thu Jun 28 07:33:26 2018"
    ## [1] " scoring treatments Thu Jun 28 07:33:26 2018"
    ## [1] "have treatment plan Thu Jun 28 07:33:26 2018"
    ## [1] "rescoring complex variables Thu Jun 28 07:33:26 2018"
    ## [1] "done rescoring complex variables Thu Jun 28 07:33:27 2018"
...
```
    ...
    ##   id) %.>%
    ##  natural_join(.,
    ##   table('vtreat_tmp_31763596667465601600_0000000000'; 
    ##     x,
    ##     x_catP),
    ##   j= LEFT, by= x) %.>%
    ##  natural_join(.,
    ##   table('vtreat_tmp_13028793943642813963_0000000000'; 
    ##     x,
    ##     x_catB),
    ##   j= LEFT, by= x) %.>%
    ##  extend(.,
...
```
    ...
    ## [1] "vtreat 1.2.1 inspecting inputs Thu Jun 28 07:33:27 2018"
    ## [1] "designing treatments Thu Jun 28 07:33:27 2018"
    ## [1] " have initial level statistics Thu Jun 28 07:33:27 2018"
    ## [1] " scoring treatments Thu Jun 28 07:33:27 2018"
    ## [1] "have treatment plan Thu Jun 28 07:33:27 2018"
    ## [1] "rescoring complex variables Thu Jun 28 07:33:27 2018"
    ## [1] "done rescoring complex variables Thu Jun 28 07:33:27 2018"
...
```
    ...
    ##   id) %.>%
    ##  natural_join(.,
    ##   table('vtreat_tmp_46074717607772533959_0000000000'; 
    ##     x,
    ##     x_catP),
    ##   j= LEFT, by= x) %.>%
    ##  natural_join(.,
    ##   table('vtreat_tmp_18163397497359401286_0000000000'; 
    ##     x,
    ##     x_catN),
    ##   j= LEFT, by= x) %.>%
    ##  natural_join(.,
    ##   table('vtreat_tmp_86154447323779292413_0000000000'; 
    ##     x,
    ##     x_catD),
    ##   j= LEFT, by= x) %.>%
    ##  extend(.,
...
```
    ...
    ## [1] "vtreat 1.2.1 inspecting inputs Thu Jun 28 07:33:28 2018"
    ## [1] "designing treatments Thu Jun 28 07:33:28 2018"
    ## [1] " have initial level statistics Thu Jun 28 07:33:28 2018"
    ## [1] " scoring treatments Thu Jun 28 07:33:28 2018"
    ## [1] "have treatment plan Thu Jun 28 07:33:28 2018"
...
```
    ...
    ##   id) %.>%
    ##  natural_join(.,
    ##   table('vtreat_tmp_40530286773513786106_0000000000'; 
    ##     x,
    ##     x_catP),
    ##   j= LEFT, by= x) %.>%
    ##  extend(.,
