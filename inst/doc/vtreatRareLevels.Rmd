...
feature.  Most of their power has since been captured in the more useful `catP` feature
...
Notice that in the sample we can observed the elevated rate of `inClass==TRUE`
