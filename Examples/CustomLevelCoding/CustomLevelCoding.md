...
One of the services that the [`R`](https://www.r-project.org) package [`vtreat`](https://winvector.github.io/vtreat/) provides is *level coding* (what we sometimes call *impact coding*):
converting the levels of a categorical variable to a meaningful and concise single numeric variable, rather than coding them as indicator variables (AKA "one-hot encoding"). Level coding can be computationally and statistically preferable to one-hot encoding for variables that have an extremely large number of possible levels. 


<figure align="center">
<img src="speed.gif">
<figcaption> Level coding is like measurement: it summarizes categories of individuals into useful numbers. Source: <a href="https://pubs.usgs.gov/gip/dinosaurs/speed.html">USGS</a></figcaption>
</figure>
...
![](CustomLevelCoding_files/figure-html/unnamed-chunk-1-1.png)<!-- -->
...
The prefacing picks the model type: numeric or regression starts with 'n.' and the categorical encoder starts with 'c.'. Currently, the only supported option is 'center,' which directs `vtreat` to center the codes with respect to the estimated grand mean. The`catN` and `catB` level codings are centered in this way.
...
## 1 county_poolN 6.401938e-19   county poolN
## 2  county_catN 2.108604e-12   county  catN
```
...
![](CustomLevelCoding_files/figure-html/nex-1.png)<!-- -->
...
![](CustomLevelCoding_files/figure-html/unnamed-chunk-2-1.png)<!-- -->
...
Thanks to [Geoffrey Simmons](https://www.linkedin.com/in/geoffrey-simmons-bb675242/), Principal Data Scientist at Echo Global Logistics, for suggesting partial pooling based level coding (and testing it for us!), introducing us to the references, and reviewing our articles.
