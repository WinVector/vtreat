...
This article documents `vtreat`'s ["fit_prepare" variation](https://github.com/WinVector/vtreat/blob/master/Examples/fit_transform/fit_transform_api.md) for regression problems.
