...
```
    ...
    ## [1] "vtreat 1.6.0 start initial treatment design Wed Mar 11 16:28:12 2020"
    ## [1] " start cross frame work Wed Mar 11 16:28:12 2020"
    ## [1] " vtreat::mkCrossFrameNExperiment done Wed Mar 11 16:28:12 2020"

Let’s look at the top of `d_prepared`. Notice that the new treated data
frame includes only new derived variables (along with `y`). The derived
...
for the outcome, and the (cross-validated) R-squared of its
...
Variables of type `catN` are the outputs of a one-variable linear
regression of a categorical variable (in our example, `xc`) against the
centered output on the (cross-validated) treated training data.
...
```
    ...
    ##     doCollar = FALSE, splitFunction = NULL, ncross = 3, forceSplit = FALSE, 
...
```
    ...
    ## [1] "vtreat 1.6.0 start initial treatment design Wed Mar 11 16:28:16 2020"
    ## [1] " start cross frame work Wed Mar 11 16:28:16 2020"
    ## [1] " vtreat::mkCrossFrameNExperiment done Wed Mar 11 16:28:16 2020"
