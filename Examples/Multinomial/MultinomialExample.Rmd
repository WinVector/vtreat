...
Similarly, the `rsq` and `sig` columns report the variable's cross-validated correlation and its cross-validated significance os a one-variable linear model for each target outcome.
...
**BUG** -- the `catB` vars still show up
