...
print(treatmentsC$scoreFrame[,c('origName', 'varName', 'code', 'rsq', 'sig', 'extraModelDegrees')])
 ...
 #  4        x    x_catP  catP 0.285095342 0.09874390                 2
 #  5        x    x_catB  catB 0.117443640 0.28930668                 2
...
print(treatmentsN$scoreFrame[,c('origName', 'varName', 'code', 'rsq', 'sig', 'extraModelDegrees')])
 ...
 #  4        x    x_catP  catP 3.700306e-01 0.1095637                 2
 #  5        x    x_catN  catN 2.606061e-01 0.1961166                 2
 #  6        x    x_catD  catD 6.666667e-02 0.5369633                 2
