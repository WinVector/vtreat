...
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/vtreat)](http://cran.r-project.org/web/packages/vtreat)

This package ('vtreat', available on [CRAN](https://cran.r-project.org/package=vtreat) and [Github](https://github.com/WinVector/vtreat)) designs variable treatments so variables have fewer exceptional
