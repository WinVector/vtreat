...
supervised machine learning in a statistically sound manner. It is available as an 
[`R` package](https://github.com/WinVector/vtreat), and also as
a [`Python`/`Pandas` package](https://github.com/WinVector/pyvtreat).
