...
[vtreat](http://winvector.github.io/vtreat/) is an [R](https://cran.r-project.org) `data.frame` and [`Python`/`Pandas`](https://github.com/WinVector/pyvtreat)
...
`vtreat` is supplied by [Win-Vector LLC](http://www.win-vector.com) under a GPL-2 | GPL-3 license, without warranty. We are also developing a [Python version of `vtreat`](https://github.com/WinVector/pyvtreat) (under a BSD 3-clause license).
